namespace System.Collections.ObjectModel
{
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        public int IndexOf(Predicate<T> filter)
        {
            return IndexOf(filter);
        }
        ...
        public void MoveUp(T item)
        {
            ...
            var items = ((List<T>)Items).GetRange(index - 1, 2);
            OnCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Move, items, index - 1, index));
        }
        ...
        public void MoveDown(T item)
        {
            ...
            var items = ((List<T>)Items).GetRange(index, 2);
            OnCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Move, items, index + 1, index));
        }
